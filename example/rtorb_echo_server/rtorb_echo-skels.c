...
static void * get_skel_small_Echo(POA_Echo *servant,
                    ...
                    case 'd':
                      switch(opname[5])
                      {
                        case 'e':
                          ...
                          {
                            case '\0':
                              *impl = (void *)servant->vepv->Echo_epv->divide;
                              *m_data = &Echo__imp.methods [5];
                              return (void *)_RtORB_impl_Echo_divide;
                              break;
                            case '2':
                              if(strcmp((opname + 7), "")){ break; }
                              *impl = (void *)servant->vepv->Echo_epv->divide2;
                              *m_data = &Echo__imp.methods [6];
                              return (void *)_RtORB_impl_Echo_divide2;
                              break;
                            default:
                              break;
                          }
                                    ...
                                    case 'n':
                                      switch(opname[9])
                                      {
                                        case 'g':
                                          ...
                                          {
                                            case '\0':
                                              *impl = (void *)servant->vepv->Echo_epv->echoString;
                                              *m_data = &Echo__imp.methods [0];
                                              return (void *)_RtORB_impl_Echo_echoString;
                                              break;
                                            case '2':
                                              if(strcmp((opname + 11), "")){ break; }
                                              *impl = (void *)servant->vepv->Echo_epv->echoString2;
                                              *m_data = &Echo__imp.methods [1];
                                              return (void *)_RtORB_impl_Echo_echoString2;
                                              break;
                                            case '3':
                                              if(strcmp((opname + 11), "")){ break; }
                                              *impl = (void *)servant->vepv->Echo_epv->echoString3;
                                              *m_data = &Echo__imp.methods [2];
                                              return (void *)_RtORB_impl_Echo_echoString3;
                                              break;
                                            default:
                                              break;
                                          }
